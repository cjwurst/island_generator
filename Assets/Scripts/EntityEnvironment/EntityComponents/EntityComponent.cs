...
public abstract class EntityComponent : MonoBehaviour
{
    ...
    protected Vector2Int Position
    {
        get
        {
            var positionRequest = new PositionsRequestedArgs(gameObject);
            director.RaisePositionsRequested(positionRequest);
            return positionRequest.Position;
        }
    }

    protected AlignmentFlags AlignmentFlags
    {
        get
        {
            var alignmentRequest = new AlignmentRequestedArgs(gameObject);
            director.RaiseAlignmentRequested(alignmentRequest);
            return alignmentRequest.AlignmentFlags;
        }
    }
